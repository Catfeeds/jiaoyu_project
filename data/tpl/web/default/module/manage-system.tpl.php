			...
			<tr ng-repeat="module in module_list">
				...
				<td class="vertical-middle table-manage-td">
					<div class="link-group">
						...
						<a href="<?php  echo url('module/manage-system/module_detail')?>&name={{ module.name }}&show=upgrade" class="color-red del" ng-if="module.new_branch && module.from == 'cloud' && isFounder == 1">新分支</a>
