	...
	<div class="combo-list">
		...
		<table class="table we7-table table-hover vertical-middle">
			...
			<tr >
				...
				<td><?php  echo $module_group['account_num']?></td>
				<td><?php  echo $module_group['wxapp_num']?></td>
				<td><?php  echo $module_group['template_num']?></td>
				<td><?php  echo $module_group['webapp_num']?></td>
				<td><?php  echo $module_group['phoneapp_num']?></td>
				<td>
			...
			<tr class="collapse bg-light-gray" aria-expanded="true" data-id="toggle-<?php  echo $module_group['id'];?>">
				<td colspan="6">
					...
					<div class="col-sm-11">
						<?php  if(is_array($module_group['account_modules'])) { foreach($module_group['account_modules'] as $module) { ?>
			...
			<tr class="collapse bg-light-gray" aria-expanded="true" data-id="toggle-<?php  echo $module_group['id'];?>">
				<td colspan="6">
					...
					<div class="col-sm-11">
						<?php  if(is_array($module_group['wxapp_modules'])) { foreach($module_group['wxapp_modules'] as $wxapp) { ?>
						<div class="col-sm-3 text-left text-over">
			...
			<tr class="collapse bg-light-gray" aria-expanded="true" data-id="toggle-<?php  echo $module_group['id'];?>">
				<td colspan="6">
					...
					<div class="col-sm-11">
						<?php  if(is_array($module_group['webapp_modules'])) { foreach($module_group['webapp_modules'] as $webapp) { ?>
						<div class="col-sm-3 text-left text-over">
			...
			<tr class="collapse bg-light-gray" aria-expanded="true" data-id="toggle-<?php  echo $module_group['id'];?>">
				<td colspan="5">
					<div class="col-sm-1 color-gray text-left we7-padding-none">PC应用</div>
					<div class="col-sm-11">
						<?php  if(is_array($module_group['phoneapp_modules'])) { foreach($module_group['phoneapp_modules'] as $phoneapp) { ?>
						<div class="col-sm-3 text-left text-over">
							<img src="<?php  echo $phoneapp['logo'];?>">
							<a href=""><?php  echo $phoneapp['title'];?></a>
						</div>
						<?php  } } ?>
					</div>
				</td>
