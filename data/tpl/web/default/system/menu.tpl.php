				...
				<li class="menu-item">
					<div class="table-div table-div-menu">
						<div class="table-div__item order">
							<i class="toggle"></i>
							<div class="we7-form">
								<input type="text" class="form-control" value="<?php  echo intval($menu['displayorder'])?>">
							</div>
						</div>
						...
						<li class="menu-item">
							<div class="table-div table-div-menu">
								<div class="table-div__item order">
									<i class="toggle"></i>
									<div class="we7-form">
										<input type="text" class="form-control" value="<?php  echo intval($section['displayorder'])?>">
									</div>
								</div>
								...
								<div class="table-div__item action">
									<div class="link-group">
										...
										<a href="javascript:;" ng-click="addSubItem('<?php  echo $section_name;?>', {title : '', displayorder : 0, isDisplay : 1})">+添加子菜单</a>
										<?php  } ?>
									</div>
								</div>
							</div>
								...
								<li class="menu-item ">
									<div class="table-div table-div-menu">
										<div class="table-div__item order">
											<i class="">&nbsp;&nbsp;&nbsp;</i>
											<div class="we7-form">
												<input type="text" class="form-control" value="<?php  echo intval($sub_menu['displayorder'])?>">
											</div>
										</div>
