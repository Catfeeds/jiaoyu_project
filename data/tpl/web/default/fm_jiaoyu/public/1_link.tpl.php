...
function showJiaoyuDialog(urlid,type,dosid) {
	...
	var alertHtml = "";
		if (types ==1){
			...
			alertHtml += "<div class=\"btn btn-default\" onclick=\"clicklinks('kc','" + urlid + "');\" title=\"课程\">课程</div>";
	...
	function clicklinks(href, urlid, dosid) {
		...
		var ipt = $("#"+urlid);
			if (ipt){
				if(href == 'galist1')
				{
					hrefs = "./index.php?i="+"<?php  echo $weid;?>" + "&c=entry&m=fm_jiaoyu" + "&do=galist&schoolid=" + "<?php  echo $schoolid;?>";
				}else if(href == 'galist2'){
					hrefs = "./index.php?i="+"<?php  echo $weid;?>" + "&c=entry&m=fm_jiaoyu" + "&do=galist&op=signup&schoolid=" + "<?php  echo $schoolid;?>";
				}else{
					hrefs = "./index.php?i="+"<?php  echo $weid;?>" + "&c=entry&m=fm_jiaoyu" + "&do=" + href + "&schoolid=" + "<?php  echo $schoolid;?>";
				}
