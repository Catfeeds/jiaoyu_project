...
<?php  if($_GPC['do'] == 'banners' || $_GPC['do'] == 'comad' || $_GPC['do'] == 'comload' || $_GPC['do'] == 'guid' || $_GPC['do'] == 'basic' || $_GPC['do'] == 'fenzu' || $_GPC['do'] == 'manager' || $_GPC['do'] == 'loginctrl' || $_GPC['do'] == 'sms' || $_GPC['do'] == 'upgrade' || $_GPC['do'] == 'binding' || $_GPC['do'] == 'school') { ?>
<?php  } else { ?>
<style>
.we7-modal-dialog, .modal-dialog {min-width: 720px!important;position: absolute;left: 25%;/* right: 0; */top: 5%;}
</style>
<?php  } ?>
<?php  } ?>