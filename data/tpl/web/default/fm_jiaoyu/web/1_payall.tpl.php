        ...
        <table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php  if($item['type'] == 8) { ?>余额充值</br>【<?php  echo $item['chongzhi'];?>】元 <?php  } else if($item['type'] ==4) { ?>报名费<?php  } else if($item['type'] ==5) { ?>考勤卡费<?php  } else if($item['type'] ==6) { ?>商城订单<?php  } else if($item['type'] ==7) { ?><?php  echo $item['vodname'];?><?php  } else { ?><?php  echo $item['obname'];?><?php  echo $item['kcname'];?><?php  if($item['ksnum'] != 0 ) { ?></br>【含<?php  echo $item['ksnum'];?>课时】<?php  } ?><?php  } ?></td>	
					...
					<td>  
						...
						<?php  } ?>
						 ...
						 <?php  if(!empty($userinfo['mobile'])) { ?><?php  echo $userinfo['mobile'];?><?php  } else { ?><?php  echo $item['signmob'];?><?php  } ?>
                    ...
                    <td>
                       <?php  if($item['status'] == 1) { ?><span class="label label-warning">未支付</span><?php  } else if($item['status'] == 2) { ?><span class="label label-success"><i class="fa fa-cloud">已支付</i></span><?php  } else if($item['status'] == 3) { ?><span class="label label-danger">已退款</span><?php  } ?>
                    </td>
					...
					<td class="qx_e_d"  style="text-align:right;">
						...
						<?php  } ?>
						<?php  if(!($item['ksnum'] != 0 && $item['type'] == 1 && $item['status'] == 2)  ) { ?>					
