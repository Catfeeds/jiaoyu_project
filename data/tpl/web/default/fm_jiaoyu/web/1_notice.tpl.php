...
<div class="panel panel-info">
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="form-group inline-form" style="display: inline-block;">
				<form accept-charset="UTF-8" action="./index.php" class="form-inline" id="diandanbao/table_search" method="get" role="form">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
						<label class="sr-only" for="q_name">按班级</label>
			...
			<a class="btn btn-danger btn-sm qx_1204" href="<?php  echo $this->createWebUrl('notice', array('op' => 'clearall'))?>"><i class="fa fa-trash-o"></i>&nbsp;清理无效阅读记录</a>
		</div>
	</div>
</div>
 <!--显示列表-->
...
<div class="panel panel-info">
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<a class="btn btn-danger btn-sm qx_1214" href="<?php  echo $this->createWebUrl('notice', array('op' => 'clearall'))?>"><i class="fa fa-trash-o"></i>&nbsp;清理无效阅读记录</a>
...
<div class="panel panel-info">
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<a class="btn btn-danger btn-sm qx_1224" href="<?php  echo $this->createWebUrl('notice', array('op' => 'clearall'))?>"><i class="fa fa-trash-o"></i>&nbsp;清理无效阅读记录</a>
		</div>
	</div>
</div>
<div class="panel panel-default">
					...
					<div class="form-group">	
						...
						<div class="col-sm-2 col-lg-2" style="width:240px">
							<select name="chuli" class="form-control" style="margin-right:15px;">
								<option value="">不限</option>
								<option value="未处理" <?php  if($_GPC['chuli'] == "未处理") { ?> selected="selected" <?php  } ?>>未处理</option>
								<option value="批准" <?php  if($_GPC['chuli'] == "批准") { ?> selected="selected" <?php  } ?>>批准</option>
								<option value="拒绝" <?php  if($_GPC['chuli'] =="拒绝" ) { ?> selected="selected" <?php  } ?>>拒绝</option>
							</select>						
						</div>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td style="overflow:hidden;">
						<?php  if(!$item['startime1']) { ?><?php  echo $item['startime'];?>至<?php  echo $item['endtime'];?><?php  } else { ?><?php  echo date('Y-m-d',$item['startime1'])?>-<?php  echo date('Y-m-d',$item['endtime1'])?><?php  } ?>
					</td>					
					<td>
