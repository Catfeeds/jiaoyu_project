			...
			<div class="panel-heading">	
				<div class="row-fluid">
					<div class="span8 control-group">
						<a class="btn btn-default" href="<?php  echo $this->createWebUrl('comad', array('op' => 'display' ))?>"><i class="fa fa-search"></i>底部广告</a>
						<a class="btn <?php  if($operation == 'post') { ?>btn-primary <?php  } else { ?>btn-default"<?php  } ?> href="<?php  echo $this->createWebUrl('comad', array('op' => 'post' ))?>"><i class="fa fa-edit"></i>底部公共广告</a>
					</div>
				</div>
			</div>
			<div class="panel-body">
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style="color:red">*</span>文字内容</label>
				...
				<div class="form-group">
					...
					<div class="help-block">图片最大高度为500，每张图片宽高请设置为相同的4比3！！！</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style="color:red">*</span>广告链接</label>
					<div class="col-sm-9 col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-6">
						...
						<div class="help-block">选择要将此广告展示的学校</div>
						<div class="help-block">注意：如在其他广告设置里已经包含了此学校，这里再次添加之前的设置将会被覆盖，请悉知</div>
					</div>
				</div>				
				<div class="form-group">
	...
	<div class="panel panel-default">
		...
		<?php  } ?>	
			...
			<div class="panel-heading">	
				<div class="row-fluid">
					<div class="span8 control-group">
						<a class="btn <?php  if($operation == 'post') { ?>btn-primary <?php  } else { ?>btn-default"<?php  } ?> href="<?php  echo $this->createWebUrl('comad', array('op' => 'post' ))?>"><i class="fa fa-edit"></i>添加广告</a>
					</div>
				</div>
			</div>
						...
						<?php  if(is_array($list)) { foreach($list as $banner) { ?>
							<tr>
								...
								<td style="text-align:left;">
									<a href="<?php  echo $this->createWebUrl('comad', array('op' => 'post', 'id' => $banner['id']))?>" data-toggle="tooltip" data-placement="top"  class="btn btn-default btn-sm manage"><i class="fa fa-edit"></i>修改</a>
									<a href="<?php  echo $this->createWebUrl('comad', array('op' => 'delete', 'id' => $banner['id']))?>" data-toggle="tooltip" data-placement="top"  class="btn btn-default btn-sm manage"><i class="fa fa-del"></i>删除</a> 
								</td>
							</tr>
						<?php  } } ?>
