...
<?php  if($op == 'display') { ?>
  <div class="clearfix">
    <div class="alert alert-danger">
      <i class="fa fa-exclamation-triangle"></i> 更新时请注意备份 微教育 数据和相关 数据库 文件！并检测系统目录addons/fm_jiaoyu/是否可写<a href="<?php  echo $this->createWebUrl('upgrade',array('op'=>'checkversion'))?>">降低版本重新检测</a>
    </div>
