...
.faceBox.faceBox_fixed{ position:fixed; padding-top: 200px; left:0; z-index:1000;}
...
function showReplyBox(id){
	closeToolBox();
	$("#wlzyid").val(id);
	var showBoxHtml='<textarea id="content_txt" rows="" cols="" placeholder="请输入您想说的话......"></textarea>'
		+'<div id="discussButton" class="discussSend">'
		+'<img id="emojiOpen" class="showEmojiBox dialog_showFace" alt="表情" src="<?php echo OSSURL;?>public/mobile/img/emojiOpen.png" width="30" height="30" onclick="showfeca();">'	
...
function showfeca() {
    ...
    var faceBox = $(".faceBox");
    var GLOBAL_NAME;
	createFaceSet(face_img_base_url+"public/mobile/img/face/", objMap, $("#content_txt"));
