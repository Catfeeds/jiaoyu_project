...
<ul class="we7-page-tab">
	...
	<li class="active"><a href="<?php  echo url('statistics/app');?>">app端访问统计信息</a></li>
...
<div class="api" id="js-statistics-app-display" ng-controller="HorizontalBarCtrl" ng-cloak>
	<div class="panel we7-panel api-target">
		<div class="panel-heading">API余量</div>
		<div class="panel-body we7-padding-vertical">
			<div class="col-sm-4 text-center">
				<div class="title"><span class="">月访问总次数</span><a href="<?php  echo url('account/post', array('uniacid' => $_W['uniacid'], 'acid' => $_W['acid']))?>" class="pull-right color-default font-default" target="_blank">去设置</a></div>
				<div><span class="today"><?php  echo $highest_visit;?></span></div>
			</div>
			<div class="col-sm-4 text-center">
				<div class="title">月访问API余量</div>
				<div><span class="today"><?php  echo $highest_visit - $month_use?></span></div>
			</div>
			<div class="col-sm-4 text-center">
				<div class="title">API总剩余量<a href="<?php  echo url('home/welcome/ext', array('m' => 'store'))?>" class="pull-right color-default font-default" target="_blank">去购买</a></div>
				<div><span class="today"><?php  echo $api_remain_num;?></span></div>
			</div>
		</div>
	</div>
	<div class="panel we7-panel api-target">
