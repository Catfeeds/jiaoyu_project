	...
	<div class="base">
		<table class="table we7-table table-hover table-form">
			...
			<tr>
				...
				<td><?php  if(permission_check_account_user('see_user_profile_edit_username')) { ?><div class="link-group"><a href="#name" data-toggle="modal" data-target="" ng-click="editInfo('username', user.username)">修改</a></div><?php  } ?></td>
			</tr>
			<tr>
		...
		<?php  if(!permission_check_account_user('see_user_add_welcome_account')) { ?>
		<?php  if($_W['role'] != ACCOUNT_MANAGE_NAME_CLERK) { ?>
		<table class="table we7-table table-hover table-form">
			<col width="160px " />
			<col />
			...
			<tr>
				...
				<td class="table-label">
					<select class="form-control tpl-category-parent we7-select" id="category_parent" ng-model="user.welcome_link" ng-change="httpChange('welcome_link')">
						<option ng-selected ="user.welcome_link == 0 || user.welcome_link == ''" ng-value="0">用户欢迎页</option>
						<option ng-selected ="user.welcome_link == 1" ng-value="1" >上次登陆最后访问页面</option>
						<option ng-selected ="user.welcome_link == 2" ng-value="2">直接跳转至公众号</option>
						<option ng-selected ="user.welcome_link == 3" ng-value="3">直接跳转至小程序</option>
						<option ng-selected ="user.welcome_link == 4" ng-value="4">直接跳转至PC</option>
						<option ng-selected ="user.welcome_link == 5" ng-value="5">直接跳转至APP</option>
					</select>
				</td>
				<td></td>
			</tr>
