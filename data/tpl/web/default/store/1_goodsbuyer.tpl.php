	...
	<div class="store <?php  if($goods['type'] == STORE_TYPE_PACKAGE) { ?>jurisdiction-detail<?php  } else { ?>module-detail<?php  } ?>">
		<div class="top">
			...
			<div class="buy pull-right">
				...
				<div class="buy-btn">
					<?php  if(in_array($goods['type'], array(STORE_TYPE_MODULE, STORE_TYPE_WXAPP_MODULE, STORE_TYPE_PACKAGE, STORE_TYPE_ACCOUNT_RENEW, STORE_TYPE_WXAPP_RENEW))) { ?>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							...
							续费小程序
							<?php  } else { ?>
							购买<span><?php  echo $goods['module']['title'];?></span>应用
							<?php  } ?>
						</h4>
					</div>
