				...
				<div class="collapse navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<?php  if(is_array($top_nav)) { foreach($top_nav as $nav) { ?>
							<?php  if(in_array($nav['name'], array(ACCOUNT_TYPE_SIGN, WXAPP_TYPE_SIGN, WEBAPP_TYPE_SIGN, PHONEAPP_TYPE_SIGN))) { ?>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<?php  $workorder_nav=$frames['section']['workorder']['menu']['system_workorder']?>
						<?php  if(empty($workorder_nav['url'])) { ?>
						<?php  $frames_site = buildframes('site')?>
						<?php  $workorder_nav=$frames_site['section']['workorder']['menu']['system_workorder']?>
						<?php  } ?>
						<?php  if(!empty($workorder_nav) && $_W['isfounder']) { ?>
						<li>
							<a href="<?php  if(empty($workorder_nav['url'])) { ?><?php  echo url('home/welcome/' . $workorder_nav['name']);?><?php  } else { ?><?php  echo $workorder_nav['url'];?><?php  } ?>" data-toggle="tooltip"  data-placement="bottom" title="工单">
								<i class="<?php  echo $workorder_nav['icon'];?> color-gray" ></i>
							</a>
						</li>
						<?php  } ?>
...
<div class="container ">
	...
	<div class="collapse navbar-collapse">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<?php  if(!empty($workorder_nav) && $_W['isfounder']) { ?>
			<li>
				<a href="<?php  if(empty($workorder_nav['url'])) { ?><?php  echo url('home/welcome/' . $workorder_nav['name']);?><?php  } else { ?><?php  echo $workorder_nav['url'];?><?php  } ?>" data-toggle="popover" data-placement="bottom"  data-trigger="hover" data-content="工单">
					<i class="<?php  echo $workorder_nav['icon'];?>" ></i>
				</a>
			</li>
			<?php  } ?>
			<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/header-notice', TEMPLATE_INCLUDEPATH)) : (include template('common/header-notice', TEMPLATE_INCLUDEPATH));?>
