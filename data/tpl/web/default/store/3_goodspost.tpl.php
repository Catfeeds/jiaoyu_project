...
<div id="js-goods-post" ng-controller="goodsPostCtrl" ng-cloak>
	...
	<form action="" class="we7-form" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group">
						...
						<input type="text" name="title" class="form-control" value="公众号" readonly>
						<?php  } else if($type == STORE_TYPE_WXAPP) { ?>
						<input type="text" name="title" class="form-control" value="小程序" readonly>
						<?php  } else if($type == STORE_TYPE_WXAPP_RENEW) { ?>
						<input type="text" name="title" class="form-control" value="小程序续费" readonly>
						<?php  } else if($type == STORE_TYPE_ACCOUNT_RENEW) { ?>
						<input type="text" name="title" class="form-control" value=" 公众号续费" readonly>
						<?php  } else { ?>
				...
				<div class="col-sm-8">
					<div class="input-group">
						...
						<div class="input-group-btn">
							...
							<input name="account_num" class="form-control" value="<?php  echo $goods_info['account_num'];?>">
							<?php  } else if($type == STORE_TYPE_WXAPP_RENEW) { ?>
							<input name="wxapp_num" class="form-control" value="<?php  echo $goods_info['wxapp_num'];?>">
							<?php  } ?>
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?php  if($type == STORE_TYPE_ACCOUNT) { ?>公众号<?php  } else { ?>小程序<?php  } ?>个数</label>
				<div class="col-sm-8">
					<div class="input-group">
						<?php  if($type == STORE_TYPE_ACCOUNT) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group">
						<select class="we7-select" name="module_group">
