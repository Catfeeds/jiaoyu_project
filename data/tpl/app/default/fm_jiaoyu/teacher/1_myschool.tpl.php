...
<div id="titlebar" class="header mainColor" style="background: #06c1ae;">
...
<div id="titlebar_bg" class="_header" style="padding-top:55px"></div>
		<div class="stuBanner">
				...
				<div class="stuInfoCenter">
					<div class="stuName">
						...
						<div id="bg_star" ><!--这里是背景，也就是灰色的星星-->
							...
							<div id="over_star" style="width:<?php  echo $teacher['star_width'];?>px"></div><!--这里是遮罩，设置宽度以达到评分的效果-->
						</div>
