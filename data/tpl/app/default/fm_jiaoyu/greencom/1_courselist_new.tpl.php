...
<body>
	...
	<div class="main">
		...
		<ul class="course-kinds">
			...
			<?php  if(is_array($CourseType)) { foreach($CourseType as $row_c) { ?>
			...
			<div class="component-dialog-body">
				<form class="form-order" novalidate="novalidate">
					...
					<div class="component-dialog-footer">
						<a type="button" class="btn-default btn close-reveal-modal " style="margin-left: 4%; width:40%;color: #fff;background-color: #f1ad31;border-color: #f1ad31;" onclick="closed()" >取消</a>
	...
	<script>
		...
		$(".action-makeorder").on("click",function(){
			$("#yyst").show();
		})
