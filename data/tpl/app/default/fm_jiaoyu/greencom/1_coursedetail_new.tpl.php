...
<head>
	...
	.reveal-modal {visibility: hidden;top: 100px; left: 2%;right:2%;background: #fff ;position: absolute;z-index: 101;    padding: 25px 18px 38px;-moz-border-radius: 5px;-webkit-border-radius: 5px;order-radius: 5px;
...
<body>
	...
	<div class="main">
		...
		<div>
			<div class="slider" style="height: 20.6rem;">
				<img data-src="<?php  echo tomedia($item['thumb'])?>" src="<?php  if($item['thumb']) { ?><?php  echo tomedia($item['thumb'])?><?php  } else { ?><?php  echo tomedia($school['thumb'])?><?php  } ?>">
			</div>
			<ol class="summary">
				<li>
		...
		<div class="teachers"><strong>授课老师</strong>
			<ul>
		...
		<?php  } ?>
		<div class="org"><strong>学校信息</strong>
		...
		<div class="relateds"><strong>学校其他课程</strong>
			<ol>
	...
	<!--积分抵用-->
	<div class="component-panel" id="syjf" style="display:none;z-index:103">
		<div class="component-dialog dialog-order">
