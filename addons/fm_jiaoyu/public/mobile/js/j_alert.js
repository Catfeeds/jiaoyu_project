	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><buttun type="button" id="popup_ok">' + $.alerts.okButton + '</buttun><span class="line_s"> </span><buttun type="button" id="popup_cancel">' + $.alerts.cancelButton + '</buttun>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
